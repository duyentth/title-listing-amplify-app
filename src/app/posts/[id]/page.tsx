...
const Posts = async ({ params }: { params: { id: string } }) => {
  ...
  return (
    <div className="flex flex-col items-center p-4 gap-4">
      ...
      <div className="border rounded w-1/2 m-auto bg-gray-200 p-4 dark:bg-gray-800">
      ...
      {comments.map((comment, idx) => (
        <div key={idx}>
          <div className="w-96 p-2 rounded border bg-yellow-100 dark:bg-gray-600 flex justify-between">
